...
public class Deck extends ArrayList<Card> implements Iterable<Card>, Serializable {
    ...
    public static void main(String args[]) throws IOException, ClassNotFoundException {
        ...
        System.out.println("\n\n");
        deck1 = new question2.Deck();
        dealt.clear();
        System.out.println("new deck in order. second number is index");
        Iterator<question2.Card> orderedIterator = deck1.OrderedIterator();
        while(orderedIterator.hasNext()){
            question2.Card c = orderedIterator.next();
//            dealt.add(c);
        ...
        Iterator<question2.Card> oddEvenIterator = deck1.OddEvenIterator();
        while(oddEvenIterator.hasNext()){
            question2.Card c = oddEvenIterator.next();
//            dealt.add(c);
            System.out.println(c);
            for (int i = 0; i < deck1.getDeck().length; i++) {
                if (c.equals(deck1.getDeck()[i])) {
